        ...
        <div class="card my-6">
            ...
            <h2 class="mb-3 mt-4 text-center" style="color:rgb(61, 61, 61);">L O G I N</h2>
              <div class="mb-3 mt-3 text-center">
                NIK : <br>
                <input class="rounded-3 border-light" type="text" name="nik" placeholder="masukan NIK anda" required
                style="width: 300px;">
              </div>
              <div class="mb-3 mt-3 text-center">
                Nama : <br>
                <input class="rounded-3 border-light" type="text" name="nama_lengkap" placeholder="masukan Nama anda" required
                style="width: 300px;">
              </div>
