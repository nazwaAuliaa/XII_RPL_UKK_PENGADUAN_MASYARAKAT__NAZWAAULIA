...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 01, 2023 at 12:33 AM
...
--
ALTER TABLE `tanggapan`
  ADD CONSTRAINT `tanggapan_ibfk_1` FOREIGN KEY (`id_petugas`) REFERENCES `petugass` (`id_petugas`) ON DELETE CASCADE ON UPDATE CASCADE,
