      ...
      <div class="col-sm-6 text-black">
        ...
        <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-2 pt-5 pt-xl-0 mt-xl-n5">
          <form action="register.php" method="post" style="width: 23rem;">
            ...
            <h3 class="fw-normal mb-2 pb-2" style="letter-spacing: 1px;">REGISTER</h3>

            <div class="form-outline mb-4">
            <label class="form-label" for="form2Example18">NIK</label>
              <input type="text" name="nik" id="form2Example18" class="form-control form-control" />
            </div>

            <div class="form-outline mb-3">
            <label class="form-label" for="form2Example28">NAMA</label>
              <input type="text" name="nama" id="form2Example28" class="form-control form-control" />
            </div>

            <div class="form-outline mb-3">
            <label class="form-label" for="form2Example28">USERNAME</label>
              <input type="text" name="username" id="form2Example28" class="form-control form-control" />
            </div>
            ...
            <div class="form-outline mb-3">
            <label class="form-label" for="form2Example28">TELPON</label>
              <input type="text" name="telp" id="form2Example28" class="form-control form-control" />
            </div>
